...
'---------------------------------------------------------------對應網站
StartURL ="https://scms.tcc.net.tw/sso/auth/certification.do?webAction=redirectPage&deviceId=PJEAP0DMVDHH23_ZA4BSAL9&hardwareId=PJEAP0DMVDHH23&macAddress=ZA4BSAL9&deviceType=WS&actvStatus=N&wsStatus=Y&unRegistedWs=&localIP=&"
